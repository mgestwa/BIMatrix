...
var zr = (i, t, e) => t in i ? jr(i, t, { enumerable: true, configurable: true, writable: true, value: e }) : i[t] = e;
var Mt = (i, t, e) => (zr(i, typeof t != "symbol" ? t + "" : t, e), e);
var ie = Math.min;
var gt = Math.max;
var di = Math.round;
var Et = (i) => ({
...
function Vr(i, t, e) {
  const o = ["left", "right"], n = ["right", "left"], s = ["top", "bottom"], r = ["bottom", "top"];
  switch (i) {
    case "top":
    case "bottom":
...
function Un(i, t, e) {
  ...
  const s = Ut(t), r = Uo(t), a = Ho(r), l = yt(t), c = s === "y", h = o.x + o.width / 2 - n.width / 2, u = o.y + o.height / 2 - n.height / 2, p = o[a] / 2 - n[a] / 2;
  let d;
  switch (l) {
    case "top":
      d = {
...
var qr = async (i, t, e) => {
  ...
  for (let y = 0; y < a.length; y++) {
    ...
    }, C && m <= 50 && (m++, typeof C == "object" && (C.placement && (p = C.placement), C.rects && (c = C.rects === true ? await r.getElementRects({
      reference: i,
      floating: t,
      strategy: n
    }) : C.rects), {
...
async function Wo(i, t) {
  ...
  const {
    ...
    altBoundary: p = false,
    padding: d = 0
  } = Ve(t, i), m = Vo(d), y = a[p ? u === "floating" ? "reference" : "floating" : u], _ = ne(await s.getClippingRect({
  ...
  } : r.reference, w = await (s.getOffsetParent == null ? void 0 : s.getOffsetParent(a.floating)), b = await (s.isElement == null ? void 0 : s.isElement(w)) ? await (s.getScale == null ? void 0 : s.getScale(w)) || {
    x: 1,
    y: 1
  } : {
    x: 1,
  ...
  return i === void 0 && (i = {}), {
    ...
    async fn(t) {
      ...
      if ((e = s.arrow) != null && e.alignmentOffset)
        return {};
      const $ = yt(n), w = Ut(a), b = yt(a) === a, v = await (l.isRTL == null ? void 0 : l.isRTL(c.floating)), C = p || (b || !y ? [ui(a)] : Ur(a)), x = m !== "none";
      !p && x && C.push(...Wr2(a, y, m, v));
      const E = [a, ...C], M = await Wo(t, _), L = [];
      ...
      if (k = [...k, {
        ...
        var P, Y;
        const S = (((P = s.flip) == null ? void 0 : P.index) || 0) + 1, z = E[S];
        if (z)
          return {
            data: {
              index: S,
            ...
            case "bestFit": {
              ...
              const V = (H = k.filter((nt) => {
                if (x) {
                  ...
                  return pt === w || // Create a bias to the `y` side axis due to horizontal
...
function Go(i) {
  const t = ie(...i.map((s) => s.left)), e = ie(...i.map((s) => s.top)), o = gt(...i.map((s) => s.right)), n = gt(...i.map((s) => s.bottom));
  return {
    x: t,
    y: e,
    width: o - t,
...
function Xr(i) {
  const t = i.slice().sort((n, s) => n.y - s.y), e = [];
  let o = null;
  ...
  return i === void 0 && (i = {}), {
    ...
    async fn(t) {
      const {
        ...
        x: l,
        y: c
      } = Ve(i, t), h = Array.from(await (s.getClientRects == null ? void 0 : s.getClientRects(o.reference)) || []), u = Xr(h), p = ne(Go(h)), d = Vo(a);
      function m() {
        ...
        if (u.length >= 2) {
          if (Ut(e) === "y") {
            const k = u[0], P = u[u.length - 1], Y = yt(e) === "top", H = k.top, S = P.bottom, z = Y ? k.left : P.left, N = Y ? k.right : P.right, V = N - z, nt = S - H;
            return {
              top: H,
              bottom: S,
              left: z,
          ...
          const _ = yt(e) === "left", $ = gt(...u.map((k) => k.right)), w = ie(...u.map((k) => k.left)), b = u.filter((k) => _ ? k.left === w : k.right === $), v = b[0].top, C = b[b.length - 1].bottom, x = w, E = $, M = E - x, L = C - v;
          return {
            top: v,
            bottom: C,
            left: x,
...
async function Qr(i, t) {
  const {
    ...
    platform: o,
    elements: n
  } = i, s = await (o.isRTL == null ? void 0 : o.isRTL(n.floating)), r = yt(e), a = xi(e), l = Ut(e) === "y", c = ["left", "top"].includes(r) ? -1 : 1, h = s && l ? -1 : 1, u = Ve(t, i);
  let {
    mainAxis: p,
    crossAxis: d,
    alignmentAxis: m
  ...
  return i === void 0 && (i = {}), {
    ...
    async fn(t) {
      const {
        ...
        x: e,
        y: o
      }, h = await Wo(t, l), u = Ut(yt(n)), p = Bo(u);
      let d = c[p], m = c[u];
      if (s) {
        const _ = p === "y" ? "top" : "left", $ = p === "y" ? "bottom" : "right", w = d + h[_], b = d - h[$];
        d = Hn(w, d, b);
      }
      if (r) {
        const _ = u === "y" ? "top" : "left", $ = u === "y" ? "bottom" : "right", w = m + h[_], b = m - h[$];
        m = Hn(w, m, b);
      }
      const y = a.fn({
        ...t,
...
function Yo(i) {
  return Ci() ? i instanceof Node || i instanceof et(i).Node : false;
}
function mt(i) {
  return Ci() ? i instanceof Element || i instanceof et(i).Element : false;
}
function ft(i) {
  return Ci() ? i instanceof HTMLElement || i instanceof et(i).HTMLElement : false;
}
function Vn(i) {
  return !Ci() || typeof ShadowRoot > "u" ? false : i instanceof ShadowRoot || i instanceof et(i).ShadowRoot;
}
function We(i) {
  const {
    overflow: t,
...
function tn(i, t, e) {
  ...
  const n = Xo(i), s = n === ((o = i.ownerDocument) == null ? void 0 : o.body), r = et(n);
  if (s) {
    const a = ia(r);
...
function Jo(i) {
  ...
  const n = ft(i), s = n ? i.offsetWidth : e, r = n ? i.offsetHeight : o, a = di(e) !== s || di(o) !== r;
  return a && (e = s, o = r), {
    width: e,
    height: o,
    $: a
...
function Zt(i) {
  ...
  let r = (s ? di(e.width) : e.width) / o, a = (s ? di(e.height) : e.height) / n;
...
function oa(i, t, e) {
  return t === void 0 && (t = false), !e || t && e !== et(i) ? false : t;
}
function Pe(i, t, e, o) {
  t === void 0 && (t = false), e === void 0 && (e = false);
  const n = i.getBoundingClientRect(), s = Qo(i);
  let r = Et(1);
  t && (o ? mt(o) && (r = Zt(o)) : r = Zt(i));
  const a = oa(s, e, o) ? Ko(s) : Et(0);
  let l = (n.left + a.x) / r.x, c = (n.top + a.y) / r.y, h = n.width / r.x, u = n.height / r.y;
  if (s) {
    const p = et(s), d = o && mt(o) ? et(o) : o;
    let m = p, y = m.frameElement;
    for (; y && o && d !== m; ) {
      const _ = Zt(y), $ = y.getBoundingClientRect(), w = st(y), b = $.left + (y.clientLeft + parseFloat(w.paddingLeft)) * _.x, v = $.top + (y.clientTop + parseFloat(w.paddingTop)) * _.y;
...
function ra(i) {
  ...
  const s = n === "fixed", r = It(o), a = t ? Zo(t.floating) : false;
  if (o === r || a && s)
    return e;
  let l = {
    scrollLeft: 0,
...
function la(i) {
  const t = It(i), e = Ei(i), o = i.ownerDocument.body, n = gt(t.scrollWidth, t.clientWidth, o.scrollWidth, o.clientWidth), s = gt(t.scrollHeight, t.clientHeight, o.scrollHeight, o.clientHeight);
...
function ca(i, t) {
  const e = et(i), o = It(i), n = e.visualViewport;
  let s = o.clientWidth, r = o.clientHeight, a = 0, l = 0;
  if (n) {
...
function da(i, t) {
  const e = Pe(i, true, t === "fixed"), o = e.top + i.clientTop, n = e.left + i.clientLeft, s = ft(i) ? Zt(i) : Et(1), r = i.clientWidth * s.x, a = i.clientHeight * s.y, l = n * s.x, c = o * s.y;
  return {
    width: r,
    height: a,
    x: l,
...
function es(i, t) {
  const e = oe(i);
  return e === t || !mt(e) || Ai(e) ? false : st(e).position === "fixed" || es(e, t);
}
function ua(i, t) {
  const e = t.get(i);
  if (e)
    return e;
  let o = tn(i, [], false).filter((a) => mt(a) && St(a) !== "body"), n = null;
...
function ha(i) {
  ...
  const s = [...e === "clippingAncestors" ? ua(t, this._c) : [].concat(e), o], r = s[0], a = s.reduce((l, c) => {
    const h = Wn(t, c, n);
...
function ma(i, t, e) {
  const o = ft(t), n = It(t), s = e === "fixed", r = Pe(i, true, s, t);
  let a = {
    scrollLeft: 0,
    scrollTop: 0
  };
  const l = Et(0);
  if (o || !o && !s)
    if ((St(t) !== "body" || We(n)) && (a = Ei(t)), o) {
      const u = Pe(t, true, s, t);
...
function is(i, t) {
  ...
  if (!ft(i) || Zo(i))
    return e;
  let o = Gn(i, t);
  for (; o && Zr(o) && st(o).position === "static"; )
    o = Gn(o, t);
  return o && (St(o) === "html" || St(o) === "body" && st(o).position === "static" && !yn(o)) ? e : o || ea(i) || e;
}
var fa = async function(i) {
  const t = this.getOffsetParent || is, e = this.getDimensions;
  return {
...
var ri = globalThis;
var _n = ri.ShadowRoot && (ri.ShadyCSS === void 0 || ri.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype;
var wn = Symbol();
var qn = /* @__PURE__ */ new WeakMap();
var as = class {
  constructor(i, t, e) {
    if (this._$cssResult$ = true, e !== wn)
...
var ya = (i) => new as(typeof i == "string" ? i : i + "", void 0, wn);
var O = (i, ...t) => {
...
var va = (i, t) => {
  if (_n)
    ...
    for (const e of t) {
      const o = document.createElement("style"), n = ri.litNonce;
      n !== void 0 && o.setAttribute("nonce", n), o.textContent = e.cssText, i.appendChild(o);
    }
};
var Yn = _n ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((t) => {
  let e = "";
  for (const o of t.cssRules)
    e += o.cssText;
  return ya(e);
})(i) : i;
var { is: _a, defineProperty: wa, getOwnPropertyDescriptor: $a, getOwnPropertyNames: xa, getOwnPropertySymbols: Ca, getPrototypeOf: Aa } = Object;
var se = globalThis;
var Xn = se.trustedTypes;
var Ea = Xn ? Xn.emptyScript : "";
var Jn = se.reactiveElementPolyfillSupport;
var Ee = (i, t) => i;
var hi = { toAttribute(i, t) {
  switch (t) {
    case Boolean:
      i = i ? Ea : null;
      break;
...
var $n = (i, t) => !_a(i, t);
var Qn = { attribute: true, type: String, converter: hi, reflect: false, hasChanged: $n };
...
var Qt = class extends HTMLElement {
  ...
  static getPropertyDescriptor(t, e, o) {
    const { get: n, set: s } = $a(this.prototype, t) ?? { get() {
      return this[e];
    }, set(r) {
      this[e] = r;
    } };
  ...
  static _$Ei() {
    if (this.hasOwnProperty(Ee("elementProperties")))
      return;
    const t = Aa(this);
    t.finalize(), t.l !== void 0 && (this.l = [...t.l]), this.elementProperties = new Map(t.elementProperties);
  }
  static finalize() {
    if (this.hasOwnProperty(Ee("finalized")))
      return;
    if (this.finalized = true, this._$Ei(), this.hasOwnProperty(Ee("properties"))) {
      const e = this.properties, o = [...xa(e), ...Ca(e)];
      for (const n of o)
  ...
  _$AK(t, e) {
    ...
    if (s !== void 0 && this._$Em !== s) {
      const r = n.getPropertyOptions(s), a = typeof r.converter == "function" ? { fromAttribute: r.converter } : ((o = r.converter) == null ? void 0 : o.fromAttribute) !== void 0 ? r.converter : hi;
      this._$Em = s, this[s] = a.fromAttribute(e, r.type), this._$Em = null;
    }
  }
  requestUpdate(t, e, o) {
    if (t !== void 0) {
      if (o ?? (o = this.constructor.getPropertyOptions(t)), !(o.hasChanged ?? $n)(this[t], e))
        return;
      this.P(t, e, o);
    }
  ...
  P(t, e, o) {
    this._$AL.has(t) || this._$AL.set(t, e), o.reflect === true && this._$Em !== t && (this._$Ej ?? (this._$Ej = /* @__PURE__ */ new Set())).add(t);
  }
  async _$ET() {
...
Qt.elementStyles = [], Qt.shadowRootOptions = { mode: "open" }, Qt[Ee("elementProperties")] = /* @__PURE__ */ new Map(), Qt[Ee("finalized")] = /* @__PURE__ */ new Map(), Jn == null || Jn({ ReactiveElement: Qt }), (se.reactiveElementVersions ?? (se.reactiveElementVersions = [])).push("2.0.4");
var pi = globalThis;
var mi = pi.trustedTypes;
var Kn = mi ? mi.createPolicy("lit-html", { createHTML: (i) => i }) : void 0;
var ls = "$lit$";
var xt = `lit$${Math.random().toFixed(9).slice(2)}$`;
var cs = "?" + xt;
var Sa = `<${cs}>`;
var Vt = document;
var Ne = () => Vt.createComment("");
var Me = (i) => i === null || typeof i != "object" && typeof i != "function";
var xn = Array.isArray;
var ka = (i) => xn(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function";
var Hi = `[ 	
\f\r]`;
var $e = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g;
var Zn = /-->/g;
var to = />/g;
var Lt = RegExp(`>|${Hi}(?:([^\\s"'>=/]+)(${Hi}*=${Hi}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g");
var eo = /'/g;
var io = /"/g;
...
var f = Ta(1);
var Wt = Symbol.for("lit-noChange");
var F = Symbol.for("lit-nothing");
var no = /* @__PURE__ */ new WeakMap();
var jt = Vt.createTreeWalker(Vt, 129);
function us(i, t) {
  if (!xn(i) || !i.hasOwnProperty("raw"))
    throw Error("invalid template strings array");
  return Kn !== void 0 ? Kn.createHTML(t) : t;
}
var Ia = (i, t) => {
  const e = i.length - 1, o = [];
  let n, s = t === 2 ? "<svg>" : t === 3 ? "<math>" : "", r = $e;
  for (let a = 0; a < e; a++) {
    const l = i[a];
    let c, h, u = -1, p = 0;
    for (; p < l.length && (r.lastIndex = p, h = r.exec(l), h !== null); )
      p = r.lastIndex, r === $e ? h[1] === "!--" ? r = Zn : h[1] !== void 0 ? r = to : h[2] !== void 0 ? (ds.test(h[2]) && (n = RegExp("</" + h[2], "g")), r = Lt) : h[3] !== void 0 && (r = Lt) : r === Lt ? h[0] === ">" ? (r = n ?? $e, u = -1) : h[1] === void 0 ? u = -2 : (u = r.lastIndex - h[2].length, c = h[1], r = h[3] === void 0 ? Lt : h[3] === '"' ? io : eo) : r === io || r === eo ? r = Lt : r === Zn || r === to ? r = $e : (r = Lt, n = void 0);
...
var Le = class _Le {
  constructor({ strings: t, _$litType$: e }, o) {
    ...
    this.parts = [];
    let s = 0, r = 0;
    const a = t.length - 1, l = this.parts, [c, h] = Ia(t, e);
    if (this.el = _Le.createElement(c, o), jt.currentNode = this.el.content, e === 2 || e === 3) {
      ...
      if (n.nodeType === 1) {
        if (n.hasAttributes())
          for (const u of n.getAttributeNames())
            if (u.endsWith(ls)) {
              const p = h[r++], d = n.getAttribute(u).split(xt), m = /([.?@])?(.*)/.exec(p);
              l.push({ type: 1, index: s, name: m[2], strings: d, ctor: m[1] === "." ? Ra : m[1] === "?" ? Pa : m[1] === "@" ? Na : Si }), n.removeAttribute(u);
            } else
              u.startsWith(xt) && (l.push({ type: 6, index: s }), n.removeAttribute(u));
        if (ds.test(n.tagName)) {
          const u = n.textContent.split(xt), p = u.length - 1;
          if (p > 0) {
            n.textContent = mi ? mi.emptyScript : "";
            for (let d = 0; d < p; d++)
              n.append(u[d], Ne()), jt.nextNode(), l.push({ type: 2, index: ++s });
            n.append(u[p], Ne());
          }
        }
...
function re(i, t, e = i, o) {
  ...
  return (r == null ? void 0 : r.constructor) !== a && ((s = r == null ? void 0 : r._$AO) == null || s.call(r, false), a === void 0 ? r = void 0 : (r = new a(i), r._$AT(i, e, o)), o !== void 0 ? (e._$Co ?? (e._$Co = []))[o] = r : e._$Cl = r), r !== void 0 && (t = re(i, r._$AS(i, t.values), r, o)), t;
}
var Oa = class {
  constructor(t, e) {
  ...
  u(t) {
    const { el: { content: e }, parts: o } = this._$AD, n = ((t == null ? void 0 : t.creationScope) ?? Vt).importNode(e, true);
    jt.currentNode = n;
    let s = jt.nextNode(), r = 0, a = 0, l = o[0];
    for (; l !== void 0; ) {
      if (r === l.index) {
        let c;
...
var Ge = class _Ge {
  ...
  constructor(t, e, o, n) {
    this.type = 2, this._$AH = F, this._$AN = void 0, this._$AA = t, this._$AB = e, this._$AM = o, this.options = n, this._$Cv = (n == null ? void 0 : n.isConnected) ?? true;
  }
  get parentNode() {
  ...
  $(t) {
    var e;
    const { values: o, _$litType$: n } = t, s = typeof n == "number" ? this._$AC(t) : (n.el === void 0 && (n.el = Le.createElement(us(n.h, n.h[0]), this.options)), n);
    if (((e = this._$AH) == null ? void 0 : e._$AD) === s)
      this._$AH.p(o);
    else {
      const r = new Oa(s, this), a = r.u(this.options);
  ...
  k(t) {
    ...
    let o, n = 0;
    for (const s of t)
      n === e.length ? e.push(o = new _Ge(this.O(Ne()), this.O(Ne()), this, this.options)) : o = e[n], o._$AI(s), n++;
    n < e.length && (this._$AR(o && o._$AB.nextSibling, n), e.length = n);
  }
  _$AR(t = this._$AA.nextSibling, e) {
    var o;
    for ((o = this._$AP) == null ? void 0 : o.call(this, false, true, e); t && t !== this._$AB; ) {
...
var Si = class {
  ...
  _$AI(t, e = this, o, n) {
    ...
    let r = false;
    if (s === void 0)
      t = re(this, t, e, 0), r = !Me(t) || t !== this._$AH && t !== Wt, r && (this._$AH = t);
    else {
      const a = t;
      let l, c;
      for (t = s[0], l = 0; l < s.length - 1; l++)
        c = re(this, a[o + l], e, l), c === Wt && (c = this._$AH[l]), r || (r = !Me(c) || c !== this._$AH[l]), c === F ? t = F : t !== F && (t += (c ?? "") + s[l + 1]), this._$AH[l] = c;
    }
    r && !n && this.j(t);
  }
  j(t) {
...
var Na = class extends Si {
  constructor(t, e, o, n, s) {
    super(t, e, o, n, s), this.type = 5;
  }
  _$AI(t, e = this) {
    if ((t = re(this, t, e, 0) ?? F) === Wt)
      return;
    const o = this._$AH, n = t === F && o !== F || t.capture !== o.capture || t.once !== o.once || t.passive !== o.passive, s = t !== F && (o === F || n);
...
var oo = pi.litHtmlPolyfillSupport;
...
var so;
I._$litElement$ = true, I.finalized = true, (so = globalThis.litElementHydrateSupport) == null || so.call(globalThis, { LitElement: I });
var ro = globalThis.litElementPolyfillSupport;
ro == null || ro({ LitElement: I });
(globalThis.litElementVersions ?? (globalThis.litElementVersions = [])).push("4.1.1");
var La2 = { attribute: true, type: String, converter: hi, reflect: false, hasChanged: $n };
var Da = (i = La2, t, e) => {
...
function g(i) {
  return (t, e) => typeof e == "object" ? Da(i, t, e) : ((o, n, s) => {
    ...
    return n.constructor.createProperty(s, r ? { ...o, wrapped: true } : o), r ? Object.getOwnPropertyDescriptor(n, s) : void 0;
  })(i, t, e);
}
function he(i) {
  return g({ ...i, state: true, attribute: false });
}
var ja = (i) => i.strings === void 0;
var hs = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6 };
var ps = (i) => (...t) => ({ _$litDirective$: i, values: t });
var ms = class {
  constructor(i) {
  }
  get _$AU() {
...
var Se = (i, t) => {
  ...
  if (o === void 0)
    return false;
  for (const n of o)
    (e = n._$AO) == null || e.call(n, t, false), Se(n, t);
  return true;
};
var fi = (i) => {
  let t, e;
...
function Fa(i, t = false, e = 0) {
  const o = this._$AH, n = this._$AN;
  if (n !== void 0 && n.size !== 0)
    if (t)
      if (Array.isArray(o))
        for (let s = e; s < o.length; s++)
          Se(o[s], false), fi(o[s]);
      else
        o != null && (Se(o, false), fi(o));
    else
      Se(this, i);
}
var Ba = (i) => {
...
var ai = (i, t) => i ? !!((i.provider === "" || i.provider.match(ke)) && (t && i.prefix === "" || i.prefix.match(ke)) && i.name.match(ke)) : false;
function Xa(i, t) {
  const e = {};
...
function lo(i, t) {
  const e = Xa(i, t);
  for (const o in en)
    o in bi ? o in i && !(o in e) && (e[o] = bi[o]) : o in t ? e[o] = t[o] : o in i && (e[o] = i[o]);
  return e;
}
function Ja(i, t) {
  const e = i.icons, o = i.aliases || /* @__PURE__ */ Object.create(null), n = /* @__PURE__ */ Object.create(null);
  function s(r) {
    if (e[r])
      return n[r] = [];
    if (!(r in n)) {
      n[r] = null;
      const a = o[r] && o[r].parent, l = a && s(a);
      l && (n[r] = [a].concat(l));
    }
    return n[r];
  }
...
function Qa(i, t, e) {
  const o = i.icons, n = i.aliases || /* @__PURE__ */ Object.create(null);
  let s = {};
  function r(a) {
    s = lo(
      o[a] || n[a],
...
function _s(i) {
  if (typeof i != "object" || i === null)
    return null;
  const t = i;
  if (typeof t.prefix != "string" || !i.icons || typeof i.icons != "object" || !Vi(i, Ka))
    return null;
  const e = t.icons;
  for (const n in e) {
    const s = e[n];
    if (!n.match(ke) || typeof s.body != "string" || !Vi(
      s,
      en
    ))
      return null;
  ...
  for (const n in o) {
    const s = o[n], r = s.parent;
    if (!n.match(ke) || typeof r != "string" || !e[r] && !o[r] || !Vi(
      s,
      en
    ))
      return null;
...
function je(i) {
  const t = typeof i == "string" ? Ye(i, true, De) : i;
  if (t) {
    const e = kt(t.provider, t.prefix), o = t.name;
    return e.icons[o] || (e.missing.has(o) ? null : void 0);
  }
}
function $s(i, t) {
  const e = Ye(i, true, De);
  if (!e)
    return false;
...
function nl(i) {
  ...
  return i.forEach((n) => {
    if (o.name === n.name && o.prefix === n.prefix && o.provider === n.provider)
      return;
    o = n;
    const s = n.provider, r = n.prefix, a = n.name, l = e[s] || (e[s] = /* @__PURE__ */ Object.create(null)), c = l[r] || (l[r] = kt(s, r));
    let h;
    ...
    t.forEach((s) => {
      ...
      r.pending = r.pending.filter((l) => {
        ...
        if (i.icons[c])
          ...
          return e = true, true;
        return false;
      }), r.pending.length !== a && (e || xs([i], s.id), s.callback(
        r.loaded.slice(0),
        r.missing.slice(0),
        r.pending.slice(0),
        s.abort
...
function cl(i, t, e, o) {
  const n = i.resources.length, s = i.random ? Math.floor(Math.random() * n) : i.index;
  let r;
  if (i.random) {
...
var sn = [];
for (; ni.length > 0; )
  ni.length === 1 || Math.random() > 0.5 ? sn.push(ni.shift()) : sn.push(ni.pop());
ki[""] = An({
  resources: ["https://api.iconify.design"].concat(sn)
});
function po(i, t) {
  const e = An(t);
  return e === null ? false : (ki[i] = e, true);
}
function Ti(i) {
  return ki[i];
}
...
function As(i, t, e) {
  ...
  if (typeof i == "string") {
    ...
    if (s) {
      o = Cs(s);
      const r = i.resources ? i.resources[0] : "", a = on(r);
      a && (n = a.send);
    }
  }
...
var oi = typeof window > "u" ? {} : window;
function Ts(i) {
  const t = i + "Storage";
  try {
    if (oi && oi[t] && typeof oi[t].length == "number")
      return oi[t];
  } catch {
  }
  Ft[i] = false;
...
function Is(i, t) {
  ...
  const n = Math.floor(Date.now() / Ss) - hl, s = (a) => {
    const l = ze + a.toString(), c = rn(e, l);
    if (typeof c == "string") {
      try {
...
function Os() {
  if (!Sn) {
    ...
    for (const i in Ft)
      Is(i, (t) => {
        const e = t.data, o = t.provider, n = e.prefix, s = kt(
          o,
          n
        );
        if (!Cn(s, e).length)
...
function yl(i, t) {
  i.iconsToLoad ? i.iconsToLoad = i.iconsToLoad.concat(t).sort() : i.iconsToLoad = t, i.iconsQueueFlag || (i.iconsQueueFlag = true, setTimeout(() => {
    ...
    const { provider: e, prefix: o } = i, n = i.iconsToLoad;
...
var kn = (i, t) => {
  ...
  return o.pending.forEach((l) => {
    ...
    const { provider: c, prefix: h, name: u } = l, p = kt(c, h), d = p.pendingIcons || (p.pendingIcons = /* @__PURE__ */ new Set());
...
var vl = (i) => new Promise((t, e) => {
  const o = typeof i == "string" ? Ye(i, true) : i;
  if (!o) {
    e(i);
    return;
  }
...
function wl(i, t) {
  const e = typeof i == "string" ? Ye(i, true, true) : null;
  if (!e) {
    const s = _l(i);
    return {
      value: i,
...
var xl = /(-?[0-9.]*[0-9]+[0-9.]*)/g;
var Cl = /^-?[0-9.]*[0-9]+[0-9.]*$/g;
function cn(i, t, e) {
  if (t === 1)
    return i;
...
function Al(i, t = "defs") {
  ...
  const o = i.indexOf("<" + t);
  for (; o >= 0; ) {
    const n = i.indexOf(">", o), s = i.indexOf("</" + t);
    if (n === -1 || s === -1)
      break;
    const r = i.indexOf(">", s);
    if (r === -1)
...
var kl = (i) => i === "unset" || i === "undefined" || i === "none";
function Ps(i, t) {
  const e = {
    ...qe,
    ...i
  ...
  let s = e.body;
  [e, o].forEach((y) => {
    const _ = [], $ = y.hFlip, w = y.vFlip;
    let b = y.rotate;
    $ ? w ? b += 2 : (_.push(
      "translate(" + (n.width + n.left).toString() + " " + (0 - n.top).toString() + ")"
    ), _.push("scale(-1 1)"), n.top = n.left = 0) : w && (_.push(
    ...
    b % 2 === 1 && (n.left !== n.top && (v = n.left, n.left = n.top, n.top = v), n.width !== n.height && (v = n.width, n.width = n.height, n.height = v)), _.length && (s = Sl(
      s,
      '<g transform="' + _.join(" ") + '">',
      "</g>"
    ));
  });
  const r = o.width, a = o.height, l = n.width, c = n.height;
  let h, u;
...
function Ls() {
  ...
  return {
    enableCache: (t) => vo(t, true),
    disableCache: (t) => vo(t, false),
    iconLoaded: uo,
    iconExists: uo,
    getIcon: il,
    listIcons: el,
...
function Co(i, t) {
  const e = t.icon.data, o = t.customisations, n = Ps(e, o);
...
function Wl(i = "iconify-icon") {
  ...
  const n = [
     ...
     */
    constructor() {
      super(), Mt(this, "_shadowRoot"), Mt(this, "_initialised", false), Mt(this, "_state"), Mt(this, "_checkQueued", false), Mt(this, "_connected", false), Mt(this, "_observer", null), Mt(this, "_visible", true);
    ...
    */
    ...
    _check() {
      ...
      if (!a.rendered || !this._visible)
        return;
      const c = this.getAttribute("mode"), h = ao(this);
     ...
     */
    _gotIconData(a) {
      this._checkQueued = false, this._renderIcon(a, ao(this), this.getAttribute("mode"));
    }
    /**
     * Re-render based on icon data
     */
    _renderIcon(a, l, c) {
      const h = $l(a.data.body, c), u = this._state.inline;
...
var js = class T {
   ...
   */
  static init() {
    T.addGlobalStyles(), T.defineCustomElement("bim-button", Zl), T.defineCustomElement("bim-checkbox", pe), T.defineCustomElement("bim-color-input", qt), T.defineCustomElement("bim-context-menu", pn), T.defineCustomElement("bim-dropdown", vt), T.defineCustomElement("bim-grid", On), T.defineCustomElement("bim-icon", ac), T.defineCustomElement("bim-input", Je), T.defineCustomElement("bim-label", fe), T.defineCustomElement("bim-number-input", it), T.defineCustomElement("bim-option", q), T.defineCustomElement("bim-panel", Yt), T.defineCustomElement("bim-panel-section", be), T.defineCustomElement("bim-selector", ge), T.defineCustomElement("bim-table", lt), T.defineCustomElement("bim-tabs", Jt), T.defineCustomElement("bim-tab", ot), T.defineCustomElement("bim-table-cell", Zs), T.defineCustomElement("bim-table-children", er), T.defineCustomElement("bim-table-group", nr), T.defineCustomElement("bim-table-row", Xt), T.defineCustomElement("bim-text-input", ct), T.defineCustomElement("bim-toolbar", Mi), T.defineCustomElement("bim-toolbar-group", Pi), T.defineCustomElement(
      "bim-toolbar-section",
      _e
    ), T.defineCustomElement("bim-viewport", mr);
  }
  static newRandomId() {
...
var U = class extends I {
  ...
  observeLastElement() {
    ...
    if (!t)
      return;
    const e = this.ELEMENTS_BEFORE_OBSERVER + this.visibleElements.length - 1, o = [...this.elements][e];
    o && t.observe(o);
  }
  ...
  static create(t, e) {
    ...
    if (t.length === 0)
      return ae(t(), o), o.firstElementChild;
    if (!e)
      throw new Error(
        "UIComponent: Initial state is required for statefull components."
      );
    let n = e;
    const s = t, r = (l) => (n = { ...n, ...l }, ae(s(n, r), o), n);
    r(e);
    const a = () => n;
...
var Fe = (i, t = {}, e = true) => {
  ...
  for (const n of i.children) {
    const s = n, r = s.getAttribute("name") || s.getAttribute("label"), a = t[r];
    if (r) {
...
function Eo(i) {
  ...
  ), e = i.split(t).map((r) => r.trim()), [o, n] = e, s = n.startsWith("'") && n.endsWith("'") ? n.replace(/'/g, "") : Ii(n);
  return { key: o, condition: t, value: s };
}
var hn = (i) => {
  try {
    const t = [], e = i.split(/&(?![^()]*\))/).map((o) => o.trim());
    for (const o of e) {
      const n = !o.startsWith("(") && !o.endsWith(")"), s = o.startsWith("(") && o.endsWith(")");
      if (n) {
        const r = Eo(o);
        t.push(r);
      }
...
var zs = (i, t, e, o) => {
  for (var n = Jl(t, e), s = i.length - 1, r; s >= 0; s--)
    (r = i[s]) && (n = r(t, e, n) || n);
  return n && Xl(t, e, n), n;
};
var G;
var In = (G = class extends I {
  constructor() {
  ...
  static removeMenus() {
    for (const i of G.menus)
      i instanceof G && (i.visible = false);
  ...
  async updatePosition() {
    if (!(this.visible && this._previousContainer))
      return;
    const i = this.placement ?? "right", t = await rs(this._previousContainer, this, {
      placement: i,
      middleware: [qo(10), ss(), os(), ns({ padding: 5 })]
    }), { x: e, y: o } = t;
  ...
  i.target === G.dialog && G.removeMenus();
    ...
    ></dialog>`), G.menus = [], G);
zs([
  g({ type: String, reflect: true })
], In.prototype, "placement");
zs([
  g({ type: Boolean, reflect: true })
], In.prototype, "visible");
var pn = In;
var Ql = Object.defineProperty;
var Kl = Object.getOwnPropertyDescriptor;
var ut = (i, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? Kl(t, e) : t, s = i.length - 1, r; s >= 0; s--)
    (r = i[s]) && (n = (o ? r(t, e, n) : r(n)) || n);
  return o && n && Ql(t, e, n), n;
};
var xe;
var rt = (xe = class extends I {
  constructor() {
    super(), this.labelHidden = false, this.active = false, this.disabled = false, this.vertical = false, this.tooltipVisible = false, this._stateBeforeLoading = {
      disabled: false,
      icon: ""
    }, this._loading = false, this._parent = le(), this._tooltip = le(), this._mouseLeave = false, this.onClick = (i) => {
      ...
      if (i) {
        ...
        for (const o of i.children)
          o instanceof xe && o.setAttribute("data-context-group", e);
        i.visible = true;
      }
...
ut([
  g({ type: Boolean, attribute: "label-hidden", reflect: true })
], rt.prototype, "labelHidden", 2);
ut([
  g({ type: Boolean, reflect: true })
], rt.prototype, "active", 2);
ut([
  g({ type: Boolean, reflect: true, attribute: "disabled" })
...
ut([
  g({ type: Number, attribute: "tooltip-time", reflect: true })
], rt.prototype, "tooltipTime", 2);
ut([
  g({ type: Boolean, attribute: "tooltip-visible", reflect: true })
], rt.prototype, "tooltipVisible", 2);
ut([
  g({ type: String, attribute: "tooltip-title", reflect: true })
], rt.prototype, "tooltipTitle", 2);
ut([
  g({ type: String, attribute: "tooltip-text", reflect: true })
...
var Bs = class extends I {
  constructor() {
    super(...arguments), this.vertical = false, this.color = "#bcf124", this._colorInput = le(), this._textInput = le(), this.onValueChange = new Event("input"), this.onOpacityInput = (t) => {
      const e = t.target;
...
var Rt = (i, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? nc(t, e) : t, s = i.length - 1, r; s >= 0; s--)
    (r = i[s]) && (n = (o ? r(t, e, n) : r(n)) || n);
  return o && n && ic(t, e, n), n;
};
var Hs = class extends I {
  constructor() {
...
Rt([
  g({ type: Boolean, attribute: "no-mark", reflect: true })
...
var Pt = (i, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? sc(t, e) : t, s = i.length - 1, r; s >= 0; s--)
    (r = i[s]) && (n = (o ? r(t, e, n) : r(n)) || n);
  return o && n && oc(t, e, n), n;
};
var Us = class extends U {
  constructor() {
    super(), this.multiple = false, this.required = false, this.vertical = false, this._visible = false, this._value = /* @__PURE__ */ new Set(), this.onValueChange = new Event("change"), this._contextMenu = le(), this.onOptionClick = (t) => {
      const e = t.target, o = this._value.has(e);
      if (!this.multiple && !this.required && !o)
        this._value = /* @__PURE__ */ new Set([e]);
      else if (!this.multiple && !this.required && o)
        ...
        const n = [...this._value].filter((r) => r !== e), s = new Set(n);
  ...
  get value() {
    return [...this._value].filter(
      (t) => t instanceof q && t.checked
    ).map((t) => t.value);
  }
  get _options() {
    const t = /* @__PURE__ */ new Set([...this.elements]);
    for (const e of this.children)
      e instanceof q && t.add(e);
    return [...t];
  }
  onSlotChange(t) {
  ...
  updateOptionsState() {
    for (const t of this._options)
      t instanceof q && (t.checked = this._value.has(t));
  }
  findOption(t) {
    return this._options.find((e) => e instanceof q ? e.label === t || e.value === t : false);
  }
  render() {
    let t, e, o;
  ...
  render() {
    if (this.layout) {
      if (this._updateFunctions = {}, this.layouts[this.layout]) {
        ...
        const t = this._updateFunctions[this.layout], e = this.layouts[this.layout], o = this.getLayoutAreas(e).map((n) => {
          const s = e.elements[n];
          if (!s)
            return null;
          if (s instanceof HTMLElement)
            return s.style.gridArea = n, s;
          if ("template" in s) {
            const { template: r, initialState: a } = s, [l, c] = U.create(r, a);
...
Qe([
  g({ type: Boolean, attribute: "icon-hidden", reflect: true })
...
var at = (i, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? uc(t, e) : t, s = i.length - 1, r; s >= 0; s--)
    (r = i[s]) && (n = (o ? r(t, e, n) : r(n)) || n);
  return o && n && dc(t, e, n), n;
};
var Ys = class extends I {
  constructor() {
    super(...arguments), this._value = 0, this.vertical = false, this.slider = false, this._input = le(), this.onValueChange = new Event("change");
  }
  set value(t) {
  ...
  setValue(t) {
    const { value: e } = this._input;
    let o = t;
    if (o = o.replace(/[^0-9.-]/g, ""), o = o.replace(/(\..*)\./g, "$1"), o.endsWith(".") || (o.lastIndexOf("-") > 0 && (o = o[0] + o.substring(1).replace(/-/g, "")), o === "-" || o === "-0"))
      return;
    let n = Number(o);
  ...
  onSliderMouseDown(t) {
    ...
    const { clientX: e } = t, o = this.value;
    let n = false;
    const s = (l) => {
      var c;
      n = true;
      ...
      document.removeEventListener("mousemove", s), document.body.style.cursor = "default", n ? n = false : (this.addEventListener("blur", r), this.slider = false, requestAnimationFrame(() => this.focus())), document.removeEventListener("mouseup", a);
    };
  ...
  render() {
    const t = f`
      ...
      ${this.suffix ? f`<bim-label
          ...
          >` : null}
    `, e = this.min ?? -1 / 0, o = this.max ?? 1 / 0, n = 100 * (this.value - e) / (o - e), s = f`
      <style>
        .slider-indicator {
          width: ${`${n}%`};
        }
...
var Ke = (i, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? pc(t, e) : t, s = i.length - 1, r; s >= 0; s--)
    (r = i[s]) && (n = (o ? r(t, e, n) : r(n)) || n);
...
Ke([
  g({ type: Boolean, attribute: "header-hidden", reflect: true })
...
var Qs = class extends I {
  constructor() {
    super(...arguments), this.vertical = false, this.onValueChange = new Event("change"), this._canEmitEvents = false, this._value = document.createElement("bim-option"), this.onOptionClick = (t) => {
      ...
      for (const e of this.children)
        e instanceof q && (e.checked = e === t.target);
    };
  }
  get _options() {
  ...
  onSlotChange(t) {
    const e = t.target.assignedElements();
    for (const o of e)
      o instanceof q && (o.noMark = true, o.removeEventListener("click", this.onOptionClick), o.addEventListener("click", this.onOptionClick));
  }
  findOption(t) {
    return this._options.find((e) => e instanceof q ? e.label === t || e.value === t : false);
  }
...
var tr = class extends I {
  ...
  toggleGroups(t, e = false) {
    for (const o of this._groups)
      o.childrenHidden = typeof t > "u" ? !o.childrenHidden : !t, e && o.toggleChildren(t, e);
  }
  render() {
...
var ir = class extends I {
  ...
  render() {
    ...
    this.data.children && !this.childrenHidden && r.append(o), r.table = this.table, r.data = this.data.data, this.table.dispatchEvent(
...
var nr = ir;
xc([
  g({ type: Boolean, attribute: "children-hidden", reflect: true })
...
var or = class extends I {
  ...
  compute() {
    ...
    const t = this.table.getRowIndentation(this.data) ?? 0, e = this.isHeader ? this.data : this.table.applyDataTransform(this.data) ?? this.data, o = [];
    for (const n in e) {
      if (this.hiddenColumns.includes(n))
        continue;
      const s = e[n];
      let r;
      if (typeof s == "string" || typeof s == "boolean" || typeof s == "number" ? (r = document.createElement("bim-label"), r.textContent = String(s)) : s instanceof HTMLElement ? r = s : (r = document.createDocumentFragment(), ae(s, r)), !r)
        continue;
...
ye([
  g({ type: Boolean, attribute: "is-header", reflect: true })
], Xt.prototype, "isHeader");
ye([
  he()
], Xt.prototype, "_intersecting");
var Ac = Object.defineProperty;
var Ec = Object.getOwnPropertyDescriptor;
var ht = (i, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? Ec(t, e) : t, s = i.length - 1, r; s >= 0; s--)
    (r = i[s]) && (n = (o ? r(t, e, n) : r(n)) || n);
...
var sr = class extends I {
    ...
    super(...arguments), this._filteredData = [], this.headersHidden = false, this.minColWidth = "4rem", this._columns = [], this._textDelimiters = {
      ...
      for (const s of n) {
        ...
        if (l.startsWith("[") && l.endsWith("]")) {
          ...
          l = c, o = Object.keys(e.data).filter((h) => h.includes(c)).map(
            (h) => So(e.data[h], r, a)
          ).some((h) => h);
        } else
          o = So(e.data[l], r, a);
  ...
  set columns(t) {
    const e = [];
    for (const o of t) {
      const n = typeof o == "string" ? { name: o, width: `minmax(${this.minColWidth}, 1fr)` } : o;
      e.push(n);
    }
  ...
  generateText(t = "comma", e = this.value, o = "", n = true) {
...
`;
    ...
    for (const [l, c] of e.entries()) {
      const { data: h, children: u } = c, p = this.indentationInText ? `${o}${l + 1}${s}` : "", d = a.map((y) => h[y] ?? ""), m = `${p}${d.join(s)}
`;
  ...
  downloadData(t = "BIM Table Data", e = "json") {
    let o = null;
    if (e === "json" && (o = new File(
      [JSON.stringify(this.value, void 0, 2)],
      `${t}.json`
    )), e === "csv" && (o = new File([this.csv], `${t}.csv`)), e === "tsv" && (o = new File([this.tsv], `${t}.tsv`)), !o)
      return;
  ...
  async loadData(t = false) {
    ...
    try {
      ...
      if (this.loading = false, this._filteredData.length !== 0)
        return false;
      const o = this.querySelector("[slot='error-loading']"), n = o == null ? void 0 : o.querySelector(
    ...
    for (const s of o)
      if (e(t, s)) {
        if (this.preserveStructureOnFilter) {
          ...
          n.push(r);
        } else if (n.push({ data: s.data }), s.children) {
          const r = this.filter(
            t,
            e,
            s.children
...
ht([
  g({ type: String, attribute: "min-col-width", reflect: true })
...
ht([
  g({ type: Boolean, reflect: true, attribute: "selectable-rows" })
], lt.prototype, "selectableRows", 2);
ht([
  g({ attribute: false })
], lt.prototype, "selection", 2);
ht([
  g({ type: Boolean, attribute: "no-indentation", reflect: true })
...
ht([
  he()
], lt.prototype, "_errorLoading", 2);
var Sc = Object.defineProperty;
var kc = Object.getOwnPropertyDescriptor;
var Ri = (i, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? kc(t, e) : t, s = i.length - 1, r; s >= 0; s--)
    (r = i[s]) && (n = (o ? r(t, e, n) : r(n)) || n);
...
var ve = (i, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? Ic(t, e) : t, s = i.length - 1, r; s >= 0; s--)
    (r = i[s]) && (n = (o ? r(t, e, n) : r(n)) || n);
...
var ar = class extends I {
  ...
  set tab(t) {
    this._tab = t;
    const e = [...this.children], o = e.find(
      (n) => n instanceof ot && n.name === t
    );
    for (const n of e) {
      if (!(n instanceof ot))
        continue;
  ...
  onSlotChange(t) {
    ...
    const e = t.target.assignedElements(), o = e.find((n) => n instanceof ot ? this.tab ? n.name === this.tab : !n.hidden : false);
    ...
    for (const n of e) {
      ...
      n.removeEventListener("hiddenchange", this.onTabHiddenChange), o !== n && (n.hidden = true), n.addEventListener("hiddenchange", this.onTabHiddenChange);
    }
  }
  render() {
    return f`
...
ve([
  he()
], Jt.prototype, "_switchers", 2);
ve([
  g({ type: Boolean, reflect: true })
], Jt.prototype, "bottom", 2);
ve([
  g({ type: Boolean, attribute: "switchers-hidden", reflect: true })
...
ve([
  g({ type: Boolean, attribute: "switchers-full", reflect: true })
], Jt.prototype, "switchersFull", 2);
var ko = (i) => i ?? F;
var Oc = Object.defineProperty;
var Rc = Object.getOwnPropertyDescriptor;
var _t = (i, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? Rc(t, e) : t, s = i.length - 1, r; s >= 0; s--)
    (r = i[s]) && (n = (o ? r(t, e, n) : r(n)) || n);
  return o && n && Oc(t, e, n), n;
};
...
var Ni = (i, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? Lc(t, e) : t, s = i.length - 1, r; s >= 0; s--)
    (r = i[s]) && (n = (o ? r(t, e, n) : r(n)) || n);
...
var ur = class extends I {
  ...
  updateChildren() {
    const t = this.children;
    for (const e of t)
      e instanceof Pi && (e.vertical = this.vertical), e.toggleAttribute("label-hidden", this.vertical);
  }
  render() {
    return f`
      <div class="parent">
...
var Rn = (i, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? jc(t, e) : t, s = i.length - 1, r; s >= 0; s--)
    (r = i[s]) && (n = (o ? r(t, e, n) : r(n)) || n);
  return o && n && Dc(t, e, n), n;
};
var hr = class extends I {
  ...
  updateSections() {
    const t = this.children;
    for (const e of t)
      e instanceof _e && (e.labelHidden = this.vertical && !Q.config.sectionLabelOnVerticalToolbar, e.vertical = this.vertical);
  }
  // firstUpdated() {
...
Rn([
  g({ type: Boolean, attribute: "labels-hidden", reflect: true })
...
var Hc = (i) => {
  const { components: t } = i, e = t.get(IfcLoader);
  return f`
    <bim-button
    ...
    n.type = "file", n.accept = ".ifc", n.onchange = async () => {
      if (n.files === null || n.files.length === 0)
        return;
      const s = n.files[0], r = s.name.replace(".ifc", "");
      n.remove();
...
var Wc = (i) => {
  const { components: t, actions: e, tags: o } = i, n = (e == null ? void 0 : e.dispose) ?? true, s = (e == null ? void 0 : e.download) ?? true, r = (e == null ? void 0 : e.visibility) ?? true, a = (o == null ? void 0 : o.schema) ?? true, l = (o == null ? void 0 : o.viewDefinition) ?? true, c = t.get(FragmentsManager), h = ({
    detail: p
  }) => {
    const { cell: d } = p;
    ...
    d.dataTransform = {
      Name: (y, _) => {
        ...
        if (!w)
          return $;
        const b = {};
        for (const k of w.items)
          b[k.id] = k.ids;
        let v;
        const { schema: C } = w.ifcMetadata;
        a && C && (v = f`
        ...
        r && (M = f`<bim-button @click=${(P) => {
          const Y = t.get(Hider), H = P.target;
        ...
        return s && (L = f`<bim-button @click=${() => {
          ...
          P.type = "file", P.accept = ".ifc", P.multiple = false, P.addEventListener("change", async () => {
            if (!(P.files && P.files.length === 1))
              return;
            const Y = P.files[0], H = await Y.arrayBuffer(), z = await t.get(IfcPropertiesManager).saveToIfc(
              w,
              new Uint8Array(H)
            ), N = new File(
              [z],
...
var Gc = (i, t = true) => {
  ...
  if (t) {
    const { components: o } = i, n = o.get(FragmentsManager), [, s] = e;
...
async function li(i, t, e, o = br, n = false) {
  const s = i.get(IfcRelationsIndexer), r = await t.getProperties(e);
  if (!r)
    return {
  ...
  for (const c in r) {
    const h = o.map((p) => typeof p == "string" ? c === p : p(c)).includes(true);
    if (!(c === "type" || h))
      continue;
    const u = r[c];
    if (u)
...
var Yc = (i) => {
  ...
  return typeof o == "function" ? a = o(br) : a = o, f`<bim-table ${K(async (c) => {
    ...
    for (const d in e) {
      ...
      if (!(m && m.group))
        continue;
      const y = m.group, _ = p.find(($) => $.model === y);
      if (_)
        for (const $ of e[d])
          _.expressIDs.add($);
      else {
        const $ = { model: y, expressIDs: new Set(e[d]) };
        p.push($);
      }
    }
    for (const d of p) {
      const { model: m, expressIDs: y } = d;
      for (const _ of y) {
        const $ = await li(
          t,
          m,
...
var wt;
var Qc = (i) => {
  const { components: t, classifications: e } = i, o = t.get(Classifier), n = t.get(Hider);
  wt || (wt = document.createElement("bim-table"), wt.headersHidden = true, wt.hiddenColumns = ["system"], wt.columns = ["Name", { name: "Actions", width: "auto" }], wt.dataTransform = {
    Actions: (r, a) => {
  ...
  const s = [];
  for (const r of e) {
    const a = typeof r == "string" ? r : r.system, l = typeof r == "string" ? r : r.label, c = o.list[a];
    c && s.push({
...
var gr = async (i, t, e) => {
  var a, l, c, h;
  const o = i.get(IfcRelationsIndexer), n = {
...
var id = async (i, t) => {
  ...
  for (const c of t) {
    if (c.type === IFCMATERIALLAYERSETUSAGE) {
      const h = (o = c.ForLayerSet) == null ? void 0 : o.value, u = await i.getProperties(h);
      if (!u)
        continue;
      for (const p of u.MaterialLayers) {
        ...
        if (!m)
          continue;
        const y = await i.getProperties(
          (n = m.Material) == null ? void 0 : n.value
        );
        if (!y)
          continue;
        const _ = {
...
var sd = async (i, t, e) => {
  var s, r;
  const { displayUnits: o } = e, n = { data: { Name: "PropertySets" } };
  for (const a of t) {
    const l = {
...
var rd = async (i, t, e) => {
  var s, r;
  const { displayUnits: o } = e, n = { data: { Name: "QuantitySets" } };
  for (const a of t) {
...
var vr = async (i, t) => {
  const o = { ...{
    ...
    includeClass: false
  }, ...t }, { groupName: n, includeClass: s } = o, r = { data: { Name: n } };
  s && (r.children || (r.children = []), r.children.push({
    data: {
      Name: "Class",
      Value: IfcCategoryMap[i.type]
    }
  }));
  for (const a in i) {
    if (ad.includes(a))
...
var ld = async (i, t, e, o, n) => {
  const r = i.get(IfcRelationsIndexer).getEntityRelations(
    t,
    e,
    "IsDefinedBy"
  );
...
var cd = async (i, t, e, o) => {
  const s = i.get(IfcRelationsIndexer).getEntityRelations(
    t,
    e,
    "HasAssociations"
  );
...
var hd = async (i, t, e) => {
  var a;
  const o = i.get(IfcRelationsIndexer), n = i.get(FragmentsManager), s = n.getModelIdMap(t);
  ...
  for (const l in s) {
    ...
    for (const d of p) {
      ...
      m.children || (m.children = []), m.children.push(_), h.get(d) && (await ld(
        i,
        c,
        d,
        m,
        e
      ), await cd(i, c, d, m), await dd(
        i,
        c,
        d,
        m
...
var pd = (i) => {
  const t = {
    ...
    ...i
  }, { components: e, fragmentIdMap: o, emptySelectionWarning: n } = t;
  return f`
    ...
    if (!a)
      return;
    const l = a;
    l.columns = [{ name: "Name", width: "12rem" }], l.headersHidden = true, l.loadFunction = () => hd(e, o, i), await l.loadData(true) && l.dispatchEvent(new Event("datacomputed"));
  })}>
      ${n ? f`
            <bim-label slot="missing-data" style="--bim-icon--c: gold" icon="ic:round-warning">
...
var fn = async (i, t, e, o) => {
  var c;
  const n = [], s = i.get(IfcRelationsIndexer), r = await t.getProperties(e);
  if (!r)
    return n;
  const { type: a } = r, l = {
    data: {
      Entity: IfcCategoryMap[a],
...
var bd = async (i, t, e, o) => {
  const n = i.get(IfcRelationsIndexer), s = [];
  for (const r of t) {
    let a;
    if (o)
      a = {
      ...
      const l = n.relationMaps[r.uuid], c = await r.getAllPropertiesOfType(
        IFCPROJECT
      );
      if (!(l && c))
        continue;
...
var bt;
var gd = (i, t) => {
  const e = i.get(FragmentsManager), { modelID: o, expressID: n, relations: s } = t;
  if (!o)
    return null;
...
var yd = (i) => {
  const { components: t, models: e, expressID: o } = i, n = i.selectHighlighterName ?? "select", s = i.hoverHighlighterName ?? "hover";
  bt || (bt = document.createElement("bim-table"), bt.hiddenColumns = ["modelID", "expressID", "relations"], bt.columns = ["Entity", "Name"], bt.headersHidden = true, bt.addEventListener("cellcreated", ({ detail: a }) => {
    const { cell: l } = a;
    l.column === "Entity" && !("Name" in l.rowData) && (l.style.gridColumn = "1 / -1");
  })), bt.addEventListener("rowcreated", (a) => {
    a.stopImmediatePropagation();
    const { row: l } = a.detail, c = t.get(La), h = gd(t, l.data);
...
var vd = (i, t = true) => {
  ...
  if (t) {
    const [, o] = e, { components: n } = i, s = n.get(FragmentsManager), r = n.get(IfcRelationsIndexer), a = () => o({ models: s.groups.values() });
...
var Ce = (i, t) => [...i.get(Grids).list.values()].find((n) => n.world === t);
var wd = (i, t) => f`
  ...
  `;
var $d = (i, t) => {
  const { postproduction: e } = i, o = e.n8ao.configuration;
  return f`
    <bim-color-input @input=${(s) => {
    const r = s.target;
    o.color = new Color(r.color);
  }} color=${t}></bim-color-input>
  `;
};
var xd = (i, t) => {
  const { color: e, opacity: o } = JSON.parse(t), { postproduction: n } = i, { customEffects: s } = n;
  return f`
...
var Cd = (i, t) => f`
    <bim-color-input @input=${(o) => {
  const n = o.target, s = new Color(n.color);
...
var D = (i, t, e, o) => {
  const n = {
    ...
    ...o
  }, { slider: s, min: r, max: a, step: l, suffix: c, prefix: h, onInputSet: u } = n;
  return f`
    <bim-number-input
      .pref=${h}
      .suffix=${c}
...
var kd = (i) => {
  const { components: t } = i, e = t.get(Worlds);
  return f`
    <bim-table @cellcreated=${({
    detail: s
  }) => {
    ...
    r.preserveStructureOnFilter = true, r.dataTransform = {
      Value: (d, m) => {
        const y = m.World, _ = e.list.get(y);
        if (!_)
          return d;
        const { scene: $, camera: w, renderer: b } = _, v = m.Name;
        ...
        if (v === "Size" && m.IsGridConfig && typeof d == "string") {
          ...
          if (!C)
            return d;
          const { x, y: E } = JSON.parse(d), M = D(
            C.material.uniforms.uSize1,
            "value",
            x,
            { slider: true, suffix: "m", prefix: "A", min: 1, max: 20 }
          ), L = D(
            C.material.uniforms.uSize2,
            "value",
            E,
        ...
        if (v === "Near Frustum" && w.three instanceof PerspectiveCamera && typeof d == "number") {
          const C = w.three;
        ...
        if (v === "Far Frustum" && w.three instanceof PerspectiveCamera && typeof d == "number") {
          const C = w.three;
        ...
        if (v === "Field of View" && w.three instanceof PerspectiveCamera && typeof d == "number") {
          const C = w.three;
        ...
        if (v === "Invert Drag" && w.hasCameraControls() && typeof d == "boolean")
          return $t(
            w.controls,
            "dollyDragInverted",
            d
          );
        if (v === "Dolly Speed" && w.hasCameraControls() && typeof d == "number")
          return D(w.controls, "dollySpeed", d, {
            slider: true,
            min: 0.5,
            max: 3,
            step: 0.1
          });
        if (v === "Truck Speed" && w.hasCameraControls() && typeof d == "number")
          return D(w.controls, "truckSpeed", d, {
            slider: true,
            min: 0.5,
            max: 6,
            step: 0.1
          });
        if (v === "Smooth Time" && w.hasCameraControls() && typeof d == "number")
          return D(w.controls, "smoothTime", d, {
            slider: true,
            min: 0.01,
            max: 2,
            step: 0.01
        ...
        if (v === "Intensity" && typeof d == "number") {
          if (m.Light && typeof m.Light == "string") {
            ...
            return C && C instanceof Light ? D(C, "intensity", d, {
              slider: true,
              min: 0,
              max: 10,
              step: 0.1
          ...
          if (m.IsAOConfig && b instanceof Wr)
            return D(
              b.postproduction.n8ao.configuration,
              "intensity",
              d,
        ...
        if (v === "Color" && typeof d == "string") {
          const C = m.Light, x = $.three.children.find(
            (E) => E.uuid === C
          );
          if (x && x instanceof Light)
            return wd(x, d);
          if (m.IsAOConfig && b instanceof Wr)
            return $d(b, d);
        }
        if (v === "Ambient Oclussion" && typeof d == "boolean" && m.IsAOConfig && b instanceof Wr)
          return Ad(b, d);
        if (v === "Half Resolution" && m.IsAOConfig && b instanceof Wr && typeof d == "boolean")
          return $t(
            b.postproduction.n8ao.configuration,
            "halfRes",
            d
          );
        if (v === "Screen Space Radius" && m.IsAOConfig && b instanceof Wr && typeof d == "boolean")
          return $t(
            b.postproduction.n8ao.configuration,
            "screenSpaceRadius",
            d
          );
        if (v === "Radius" && m.IsAOConfig && b instanceof Wr && typeof d == "number")
          return D(
            b.postproduction.n8ao.configuration,
            "aoRadius",
            d,
        ...
        if (v === "Denoise Samples" && m.IsAOConfig && b instanceof Wr && typeof d == "number")
          return D(
            b.postproduction.n8ao.configuration,
            "denoiseSamples",
            d,
        ...
        if (v === "Samples" && m.IsAOConfig && b instanceof Wr && typeof d == "number")
          return D(
            b.postproduction.n8ao.configuration,
            "aoSamples",
            d,
        ...
        if (v === "Denoise Radius" && m.IsAOConfig && b instanceof Wr && typeof d == "number")
          return D(
            b.postproduction.n8ao.configuration,
            "denoiseRadius",
            d,
        ...
        if (v === "Distance Falloff" && m.IsAOConfig && b instanceof Wr && typeof d == "number")
          return D(
            b.postproduction.n8ao.configuration,
            "distanceFalloff",
            d,
        ...
        if (v === "Directional Light" && m.Light && typeof m.Light == "string" && typeof d == "boolean") {
          ...
          return C && C instanceof Light ? $t(C, "visible", d) : d;
        }
        ...
        if (v === "Position" && m.Light && typeof m.Light == "string" && typeof d == "string") {
          ...
          if (!(C && C instanceof Light))
            return d;
          const { x, y: E, z: M } = JSON.parse(d), L = D(C.position, "x", x, {
            slider: true,
            prefix: "X",
            suffix: "m",
            min: -50,
        ...
        return v === "Custom Effects" && m.IsCEConfig && b instanceof Wr && typeof d == "boolean" ? Sd(b, d) : v === "Color" && m.IsOutlineConfig && b instanceof Wr && typeof d == "string" ? xd(b, d) : v === "Tolerance" && m.IsOutlineConfig && b instanceof Wr && typeof d == "number" ? D(
          b.postproduction.customEffects,
          "tolerance",
          d,
          { slider: true, min: 0, max: 6, step: 0.01 }
        ) : v === "Outline" && m.IsOutlineConfig && b instanceof Wr && typeof d == "boolean" ? $t(
          b.postproduction.customEffects,
          "outlineEnabled",
          d
        ) : v === "Gloss" && m.IsGlossConfig && b instanceof Wr && typeof d == "boolean" ? $t(
          b.postproduction.customEffects,
          "glossEnabled",
          d
        ) : v === "Min" && m.IsGlossConfig && b instanceof Wr && typeof d == "number" ? D(
          b.postproduction.customEffects,
          "minGloss",
          d,
          { slider: true, min: -0.5, max: 0.5, step: 0.01 }
        ) : v === "Max" && m.IsGlossConfig && b instanceof Wr && typeof d == "number" ? D(
          b.postproduction.customEffects,
          "maxGloss",
          d,
          { slider: true, min: -0.5, max: 0.5, step: 0.01 }
        ) : v === "Exponent" && m.IsGlossConfig && b instanceof Wr && typeof d == "number" ? D(
          b.postproduction.customEffects,
          "glossExponent",
          d,
          { slider: true, min: 0, max: 5, step: 0.01 }
        ) : v === "Gamma Correction" && m.IsGammaConfig && b instanceof Wr && typeof d == "boolean" ? Ed(b, d) : d;
      }
    };
    const a = [];
    for (const [, d] of e.list) {
      const { scene: m, camera: y, renderer: _ } = d, $ = Ce(t, d), w = {
        data: {
          Name: d instanceof SimpleWorld && d.name || d.uuid
        },
        children: []
      };
      if (m) {
        ...
        if ($) {
          const E = `#${$.material.uniforms.uColor.value.getHexString()}`, M = JSON.stringify({
        ...
        const v = m.three.children.filter(
          (x) => x instanceof DirectionalLight
        );
        for (const x of v) {
          const E = {
            data: {
        ...
        const C = m.three.children.filter(
          (x) => x instanceof AmbientLight
        );
        for (const x of C) {
          const E = {
            data: {
      ...
      if (y.three instanceof PerspectiveCamera) {
        const b = {
          data: {
      ...
      if (_ instanceof Wr) {
        const { postproduction: b } = _, v = b.n8ao.configuration, C = {
          data: {
            Name: "Renderer"
          },
          children: [
...
var Td = (i, t = true) => {
  ...
  if (t) {
    const [, o] = e, { components: n } = i;
    n.get(Worlds).list.onItemDeleted.add(() => o());
  }
  return e;
};
...
var te = (i, t) => {
  const e = t[i], o = (e == null ? void 0 : e.name) ?? i, n = o.trim().split(/\s+/);
  let s, r;
...
var Ie = globalThis;
var vi = Ie.trustedTypes;
var To = vi ? vi.createPolicy("lit-html", { createHTML: (i) => i }) : void 0;
var _r = "$lit$";
var Ct = `lit$${Math.random().toFixed(9).slice(2)}$`;
var wr = "?" + Ct;
var Od = `<${wr}>`;
var Gt = document;
var Be = () => Gt.createComment("");
var He = (i) => i === null || typeof i != "object" && typeof i != "function";
var Pn = Array.isArray;
var Rd = (i) => Pn(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function";
var Yi = `[ 	
\f\r]`;
var Ae = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g;
var Io = /-->/g;
var Oo = />/g;
var Dt = RegExp(`>|${Yi}(?:([^\\s"'>=/]+)(${Yi}*=${Yi}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g");
var Ro = /'/g;
var Po = /"/g;
var $r = /^(?:script|style|textarea|title)$/i;
var Pd = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e });
var Nn = Pd(1);
var de = Symbol.for("lit-noChange");
var B = Symbol.for("lit-nothing");
var No = /* @__PURE__ */ new WeakMap();
var zt = Gt.createTreeWalker(Gt, 129);
function xr(i, t) {
...
var Nd = (i, t) => {
  const e = i.length - 1, o = [];
  let n, s = t === 2 ? "<svg>" : t === 3 ? "<math>" : "", r = Ae;
  for (let a = 0; a < e; a++) {
    const l = i[a];
    let c, h, u = -1, p = 0;
    for (; p < l.length && (r.lastIndex = p, h = r.exec(l), h !== null); )
      p = r.lastIndex, r === Ae ? h[1] === "!--" ? r = Io : h[1] !== void 0 ? r = Oo : h[2] !== void 0 ? ($r.test(h[2]) && (n = RegExp("</" + h[2], "g")), r = Dt) : h[3] !== void 0 && (r = Dt) : r === Dt ? h[0] === ">" ? (r = n ?? Ae, u = -1) : h[1] === void 0 ? u = -2 : (u = r.lastIndex - h[2].length, c = h[1], r = h[3] === void 0 ? Dt : h[3] === '"' ? Po : Ro) : r === Po || r === Ro ? r = Dt : r === Io || r === Oo ? r = Ae : (r = Dt, n = void 0);
...
var Ue = class _Ue {
  constructor({ strings: t, _$litType$: e }, o) {
    ...
    this.parts = [];
    let s = 0, r = 0;
    const a = t.length - 1, l = this.parts, [c, h] = Nd(t, e);
    if (this.el = _Ue.createElement(c, o), zt.currentNode = this.el.content, e === 2 || e === 3) {
      const u = this.el.content.firstChild;
      u.replaceWith(...u.childNodes);
    }
    for (; (n = zt.nextNode()) !== null && l.length < a; ) {
      if (n.nodeType === 1) {
        if (n.hasAttributes())
          for (const u of n.getAttributeNames())
            if (u.endsWith(_r)) {
              const p = h[r++], d = n.getAttribute(u).split(Ct), m = /([.?@])?(.*)/.exec(p);
              l.push({ type: 1, index: s, name: m[2], strings: d, ctor: m[1] === "." ? Ld : m[1] === "?" ? Dd : m[1] === "@" ? jd : Li }), n.removeAttribute(u);
            } else
              u.startsWith(Ct) && (l.push({ type: 6, index: s }), n.removeAttribute(u));
        if ($r.test(n.tagName)) {
          const u = n.textContent.split(Ct), p = u.length - 1;
          if (p > 0) {
            n.textContent = vi ? vi.emptyScript : "";
            for (let d = 0; d < p; d++)
              n.append(u[d], Be()), zt.nextNode(), l.push({ type: 2, index: ++s });
            n.append(u[p], Be());
          }
        }
      } else if (n.nodeType === 8)
        if (n.data === wr)
          ...
          let u = -1;
          for (; (u = n.data.indexOf(Ct, u + 1)) !== -1; )
            l.push({ type: 7, index: s }), u += Ct.length - 1;
        }
      s++;
    }
  }
...
function ue(i, t, e = i, o) {
  ...
  return (n == null ? void 0 : n.constructor) !== s && ((a = n == null ? void 0 : n._$AO) == null || a.call(n, false), s === void 0 ? n = void 0 : (n = new s(i), n._$AT(i, e, o)), o !== void 0 ? (e._$Co ?? (e._$Co = []))[o] = n : e._$Cl = n), n !== void 0 && (t = ue(i, n._$AS(i, t.values), n, o)), t;
}
var Md = class {
  constructor(t, e) {
    this._$AV = [], this._$AN = void 0, this._$AD = t, this._$AM = e;
  ...
  u(t) {
    const { el: { content: e }, parts: o } = this._$AD, n = ((t == null ? void 0 : t.creationScope) ?? Gt).importNode(e, true);
    zt.currentNode = n;
    let s = zt.nextNode(), r = 0, a = 0, l = o[0];
    for (; l !== void 0; ) {
      if (r === l.index) {
        let c;
...
var ei = class _ei {
  ...
  constructor(t, e, o, n) {
    this.type = 2, this._$AH = B, this._$AN = void 0, this._$AA = t, this._$AB = e, this._$AM = o, this.options = n, this._$Cv = (n == null ? void 0 : n.isConnected) ?? true;
  }
  get parentNode() {
    let t = this._$AA.parentNode;
    const e = this._$AM;
  ...
  $(t) {
    var s;
    const { values: e, _$litType$: o } = t, n = typeof o == "number" ? this._$AC(t) : (o.el === void 0 && (o.el = Ue.createElement(xr(o.h, o.h[0]), this.options)), o);
    if (((s = this._$AH) == null ? void 0 : s._$AD) === n)
      this._$AH.p(e);
    else {
      const r = new Md(n, this), a = r.u(this.options);
  ...
  k(t) {
    ...
    let o, n = 0;
    for (const s of t)
      n === e.length ? e.push(o = new _ei(this.O(Be()), this.O(Be()), this, this.options)) : o = e[n], o._$AI(s), n++;
    n < e.length && (this._$AR(o && o._$AB.nextSibling, n), e.length = n);
  }
  _$AR(t = this._$AA.nextSibling, e) {
    var o;
...
var Li = class {
  ...
  _$AI(t, e = this, o, n) {
    ...
    let r = false;
    if (s === void 0)
      t = ue(this, t, e, 0), r = !He(t) || t !== this._$AH && t !== de, r && (this._$AH = t);
    else {
      const a = t;
      let l, c;
      for (t = s[0], l = 0; l < s.length - 1; l++)
        c = ue(this, a[o + l], e, l), c === de && (c = this._$AH[l]), r || (r = !He(c) || c !== this._$AH[l]), c === B ? t = B : t !== B && (t += (c ?? "") + s[l + 1]), this._$AH[l] = c;
    }
    r && !n && this.j(t);
  }
  j(t) {
...
var jd = class extends Li {
  constructor(t, e, o, n, s) {
    super(t, e, o, n, s), this.type = 5;
  }
  _$AI(t, e = this) {
    if ((t = ue(this, t, e, 0) ?? B) === de)
      return;
    const o = this._$AH, n = t === B && o !== B || t.capture !== o.capture || t.once !== o.once || t.passive !== o.passive, s = t !== B && (o === B || n);
    n && this.element.removeEventListener(this.name, this, o), s && this.element.addEventListener(this.name, this, t), this._$AH = t;
  }
  handleEvent(t) {
    var e;
...
var Xi = Ie.litHtmlPolyfillSupport;
...
var Bd = (i) => i.strings === void 0;
var Hd = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6 };
var Ud = (i) => (...t) => ({ _$litDirective$: i, values: t });
var Vd = class {
  constructor(t) {
  }
  get _$AU() {
...
var Oe = (i, t) => {
  ...
  if (e === void 0)
    return false;
  for (const n of e)
    (o = n._$AO) == null || o.call(n, t, false), Oe(n, t);
  return true;
};
var _i = (i) => {
  let t, e;
...
var Ar = (i) => {
  ...
  }), l = t.get(BCFTopics), c = (o == null ? void 0 : o.title) ?? (e == null ? void 0 : e.title) ?? Topic.default.title, h = (o == null ? void 0 : o.status) ?? (e == null ? void 0 : e.status) ?? Topic.default.status, u = (o == null ? void 0 : o.type) ?? (e == null ? void 0 : e.type) ?? Topic.default.type, p = (o == null ? void 0 : o.priority) ?? (e == null ? void 0 : e.priority) ?? Topic.default.priority, d = (o == null ? void 0 : o.assignedTo) ?? (e == null ? void 0 : e.assignedTo) ?? Topic.default.assignedTo, m = (o == null ? void 0 : o.labels) ?? (e == null ? void 0 : e.labels) ?? Topic.default.labels, y = (o == null ? void 0 : o.stage) ?? (e == null ? void 0 : e.stage) ?? Topic.default.stage, _ = (o == null ? void 0 : o.description) ?? (e == null ? void 0 : e.description) ?? Topic.default.description, $ = e != null && e.dueDate ? e.dueDate.toISOString().split("T")[0] : null, w = /* @__PURE__ */ new Set([...l.config.statuses]);
  h && w.add(h);
  ...
  }, Y = `btn-${Q.newRandomId()}`, H = `btn-${Q.newRandomId()}`;
  return f`
    <div ${K(M)} style="display: flex; flex-direction: column; gap: 0.75rem;">
      ...
      <div style="display: flex; gap: 0.375rem">
        <bim-dropdown vertical label="Labels" name="labels" multiple>
          ${[...x].map((S) => f`<bim-option label=${S} .checked=${m ? [...m].includes(S) : false}></bim-option>`)}
        </bim-dropdown>
        <bim-dropdown vertical label="Assignee" name="assignedTo">
          ${[...C].map((S) => {
    const z = r != null && r.users ? r.users[S] : null, N = z ? z.name : S, V = z == null ? void 0 : z.picture;
...
var Kd = (i) => {
  const { components: t, dataStyles: e, onTopicEnter: o } = i, n = t.get(BCFTopics), s = i.topics ?? n.list.values();
  return f`
    ...
    l.hiddenColumns.length === 0 && (l.hiddenColumns = ["Guid"]), l.columns = ["Title"], l.dataTransform = {
      ...
      Priority: (c) => {
        ...
        return f`
          <bim-label
            ...
            style=${Bt({ ...ee, ...u == null ? void 0 : u.style })}
          >${c}
          </bim-label>
        `;
      },
      ...
      Author: (c) => typeof c != "string" ? c : te(
        c,
        (e == null ? void 0 : e.users) ?? tt.users
      ),
      Assignee: (c) => typeof c != "string" ? c : te(
        c,
        (e == null ? void 0 : e.users) ?? tt.users
      )
    }, l.data = [...s].map((c) => {
...
var Er = (i, t = true) => {
  ...
  if (t) {
    const { components: o, topics: n } = i, [, s] = e, r = o.get(BCFTopics);
    if (r.list.onItemUpdated.add(() => s()), r.list.onItemDeleted.add(() => s()), n)
      for (const a of n)
...
var Zd = Object.freeze(Object.defineProperty({
  __proto__: null,
  topicsList: Er
}, Symbol.toStringTag, { value: "Module" }));
var tu = (i) => {
  const { topic: t, styles: e, viewpoint: o } = i, n = { delete: true, ...i.actions };
  return f`
    <bim-table no-indentation ${K((r) => {
    if (!r)
      return;
    const a = r;
    a.headersHidden = true, a.hiddenColumns = ["guid", "author"], a.dataTransform = {
      Comment: (c, h) => {
        const { guid: u } = h;
        if (typeof u != "string")
          return c;
...
var iu = (i) => {
  var l;
  const { components: t, topic: e } = i, o = {
    ...
    unlink: !!e,
    ...i.actions
  }, n = t.get(Viewpoints), s = ((l = i.topic) == null ? void 0 : l.viewpoints) ?? n.list.keys(), r = [];
  for (const c of s) {
  ...
  return f`
    ...
    if (!c)
      return;
    const h = c;
    h.addEventListener("cellcreated", ({ detail: u }) => {
      const { cell: p } = u;
      p.style.padding = "0.25rem";
    }), h.headersHidden = true, h.hiddenColumns = ["Guid"], h.columns = ["Title", { name: "Actions", width: "auto" }], h.dataTransform = {
      Actions: (u, p) => {
        const { Guid: d } = p;
...
var kr = (i, t = true) => {
  const e = U.create(
    iu,
    i
  ), { components: o, topic: n } = i;
  if (t) {
    const [, s] = e, r = o.get(Viewpoints);
...
var au = (i, t) => {
  const { components: e, editing: o, topic: n, styles: s } = i, r = {
    update: true,
    ...i.actions
  }, a = (s == null ? void 0 : s.priorities) ?? tt.priorities, l = (s == null ? void 0 : s.statuses) ?? tt.statuses, c = (s == null ? void 0 : s.types) ?? tt.types;
  let h;
  ...
  return o ? d = Ar({
    ...
    onCancel: () => {
      ...
      <div style="display: flex; gap: 0.375rem">
        ...
        <bim-label .icon=${p == null ? void 0 : p.icon} style=${Bt({ ...ee, ...p == null ? void 0 : p.style })}
        >${n.status}
        </bim-label>
      </div>
      ...
      <div style="display: flex; gap: 0.375rem">
        ...
        <bim-label .icon=${u == null ? void 0 : u.icon} style=${Bt({ ...ee, ...u == null ? void 0 : u.style })}
        >${n.type}
        </bim-label>
      </div>
      ...
      ${n.priority ? f`
            <div style="display: flex; gap: 0.375rem">
              ...
              <bim-label .icon=${h == null ? void 0 : h.icon} style=${Bt({ ...ee, ...h == null ? void 0 : h.style })}
              >${n.priority}
              </bim-label>
            </div>` : null}
...
var lu = (i) => U.create(au, i);
var cu = Object.freeze(Object.defineProperty({
  __proto__: null,
  topicInformation: lu
}, Symbol.toStringTag, { value: "Module" }));
var du = (i, t) => {
  const { showInput: e, topic: o, styles: n } = i, s = {
    add: true,
    delete: true,
    ...i.actions
  }, r = `input-${Q.newRandomId()}`, a = `btn-${Q.newRandomId()}`, l = `btn-${Q.newRandomId()}`, c = () => document.getElementById(a), h = () => document.getElementById(r), u = () => {
    const v = h();
    ...
    const v = h(), C = u();
    v && C && (o.createComment(v.value), t({ showInput: false }));
  }, m = () => {
    t({ showInput: false });
  }, y = () => {
    const v = c();
...
var pu = (i, t) => {
  const { components: e, topic: o, linking: n } = i, s = e.get(BCFTopics), r = {
    link: true,
    ...i.actions
  }, [a, l] = Er({
    components: e,
  ...
  if (n) {
    ...
    const p = a.data.filter(($) => {
      const { Guid: w } = $.data;
      return typeof w != "string" ? false : o.relatedTopics.has(w);
    }).map(($) => $.data);
    a.selection = new Set(p);
    const d = () => {
      const $ = [...a.selection].map(({ Guid: w }) => typeof w != "string" ? null : s.list.has(w) ? w : null).map((w) => w);
      o.relatedTopics.clear(), o.relatedTopics.add(...$), t({ linking: false });
    }, m = () => {
      t({ linking: false });
    }, y = `btn-${Q.newRandomId()}`, _ = `btn-${Q.newRandomId()}`;
    h = f`
...
var mu = (i) => U.create(pu, i);
var fu = Object.freeze(Object.defineProperty({
  __proto__: null,
  topicRelations: mu
}, Symbol.toStringTag, { value: "Module" }));
var bu = (i, t) => {
  const { components: e, topic: o, world: n, linking: s } = i, r = {
    add: true,
    link: true,
    selectComponents: true,
    colorizeComponent: true,
  ...
  if (s) {
    ...
    const d = l.data.filter((w) => {
      const { Guid: b } = w.data;
      return typeof b != "string" ? false : o.viewpoints.has(b);
    }).map((w) => w.data);
    l.selection = new Set(d);
    const m = () => {
      const w = [...l.selection].map(({ Guid: b }) => typeof b != "string" ? null : a.list.has(b) ? b : null).map((b) => b);
      o.viewpoints.clear(), o.viewpoints.add(...w), t({ linking: false });
    }, y = () => {
      t({ linking: false });
    }, _ = `btn-${Q.newRandomId()}`, $ = `btn-${Q.newRandomId()}`;
    u = f`
      <div style="display: flex; gap: 0.25rem">
        <style>
          #${_}:hover {
    ...
    const d = () => {
      ...
      t({ linking: true });
    }, y = f`<bim-button style="flex: 0" @click=${d} .disabled=${!n} icon="mi:add"></bim-button>`, _ = f`<bim-button style="flex: 0" @click=${m} icon="tabler:link"></bim-button>`;
    p = f`
      <div style="display: flex; justify-content: right; gap: 0.25rem">
        ${h()}
        <div style="display: flex; justify-content: right; gap: 0.25rem">
...
var ci = globalThis;
var Mn = ci.ShadowRoot && (ci.ShadyCSS === void 0 || ci.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype;
var Ln = Symbol();
var Mo = /* @__PURE__ */ new WeakMap();
var Tr = class {
  constructor(t, e, o) {
    if (this._$cssResult$ = true, o !== Ln)
      throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
...
var vu = (i) => new Tr(typeof i == "string" ? i : i + "", void 0, Ln);
var Dn = (i, ...t) => {
  const e = i.length === 1 ? i[0] : t.reduce((o, n, s) => o + ((r) => {
    if (r._$cssResult$ === true)
      return r.cssText;
...
var _u = (i, t) => {
  if (Mn)
    ...
    for (const e of t) {
      const o = document.createElement("style"), n = ci.litNonce;
      n !== void 0 && o.setAttribute("nonce", n), o.textContent = e.cssText, i.appendChild(o);
    }
};
var Lo = Mn ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((t) => {
  let e = "";
  for (const o of t.cssRules)
    e += o.cssText;
  return vu(e);
})(i) : i;
var { is: wu, defineProperty: $u, getOwnPropertyDescriptor: xu, getOwnPropertyNames: Cu, getOwnPropertySymbols: Au, getPrototypeOf: Eu } = Object;
var At = globalThis;
var Do = At.trustedTypes;
var Su = Do ? Do.emptyScript : "";
var Qi = At.reactiveElementPolyfillSupport;
var Re = (i, t) => i;
var wi = { toAttribute(i, t) {
  switch (t) {
    case Boolean:
      i = i ? Su : null;
      break;
...
var jn = (i, t) => !wu(i, t);
var jo = { attribute: true, type: String, converter: wi, reflect: false, hasChanged: jn };
...
var Kt = class extends HTMLElement {
  ...
  static getPropertyDescriptor(t, e, o) {
    const { get: n, set: s } = xu(this.prototype, t) ?? { get() {
      return this[e];
    }, set(r) {
      this[e] = r;
    } };
  ...
  static _$Ei() {
    if (this.hasOwnProperty(Re("elementProperties")))
      return;
    const t = Eu(this);
    t.finalize(), t.l !== void 0 && (this.l = [...t.l]), this.elementProperties = new Map(t.elementProperties);
  }
  static finalize() {
    if (this.hasOwnProperty(Re("finalized")))
      return;
    if (this.finalized = true, this._$Ei(), this.hasOwnProperty(Re("properties"))) {
      const e = this.properties, o = [...Cu(e), ...Au(e)];
      for (const n of o)
        this.createProperty(n, e[n]);
    }
    const t = this[Symbol.metadata];
  ...
  _$AK(t, e) {
    ...
    if (n !== void 0 && this._$Em !== n) {
      const r = o.getPropertyOptions(n), a = typeof r.converter == "function" ? { fromAttribute: r.converter } : ((s = r.converter) == null ? void 0 : s.fromAttribute) !== void 0 ? r.converter : wi;
      this._$Em = n, this[n] = a.fromAttribute(e, r.type), this._$Em = null;
    }
  }
  requestUpdate(t, e, o) {
    if (t !== void 0) {
      if (o ?? (o = this.constructor.getPropertyOptions(t)), !(o.hasChanged ?? jn)(this[t], e))
        return;
      this.P(t, e, o);
    }
    this.isUpdatePending === false && (this._$ES = this._$ET());
...
Kt.elementStyles = [], Kt.shadowRootOptions = { mode: "open" }, Kt[Re("elementProperties")] = /* @__PURE__ */ new Map(), Kt[Re("finalized")] = /* @__PURE__ */ new Map(), Qi == null || Qi({ ReactiveElement: Kt }), (At.reactiveElementVersions ?? (At.reactiveElementVersions = [])).push("2.0.4");
...
var zo;
Ht._$litElement$ = true, Ht.finalized = true, (zo = globalThis.litElementHydrateSupport) == null || zo.call(globalThis, { LitElement: Ht });
var Ki = globalThis.litElementPolyfillSupport;
Ki == null || Ki({ LitElement: Ht });
(globalThis.litElementVersions ?? (globalThis.litElementVersions = [])).push("4.1.1");
var ku = { attribute: true, type: String, converter: wi, reflect: false, hasChanged: jn };
var Tu = (i = ku, t, e) => {
  const { kind: o, metadata: n } = e;
  let s = globalThis.litPropertyMetadata.get(n);
  if (s === void 0 && globalThis.litPropertyMetadata.set(n, s = /* @__PURE__ */ new Map()), s.set(e.name, i), o === "accessor") {
...
function Iu(i) {
  return Z({ ...i, state: true, attribute: false });
}
...
var Ru = class {
  constructor(t, e) {
    ...
    const o = this.newGrid(-1), n = this.newGrid(-2);
    this.grids = { main: o, secondary: n }, this._group.add(n, o, this.numbers);
  }
  set scaleX(t) {
  ...
  regenerate() {
    ...
    const { planes: o } = this._frustum, n = o[0].constant * -o[0].normal.x, s = o[1].constant * -o[1].normal.x, r = o[2].constant * -o[2].normal.y, a = o[3].constant * -o[3].normal.y, l = Math.abs(n - s), c = Math.abs(a - r), { clientWidth: h, clientHeight: u } = this._container, p = Math.max(h, u), m = Math.max(l, c) / p, y = Math.ceil(Math.log10(l / this.scaleX)), _ = Math.ceil(Math.log10(c / this.scaleY)), $ = 10 ** (y - 2) * this.scaleX, w = 10 ** (_ - 2) * this.scaleY, b = $ * this.gridsFactor, v = w * this.gridsFactor, C = Math.ceil(c / v), x = Math.ceil(l / b), E = Math.ceil(c / w), M = Math.ceil(l / $), L = $ * Math.ceil(s / $), k = w * Math.ceil(r / w), P = b * Math.ceil(s / b), Y = v * Math.ceil(r / v), H = [...this.numbers.children];
    for (const X of H)
      X.removeFromParent();
    this.numbers.children = [];
    const S = [], z = 9 * m, N = 1e4, V = P + this._offsetX, nt = Math.round(Math.abs(V / this.scaleX) * N) / N, pt = (x - 1) * b, Di = Math.round(Math.abs((V + pt) / this.scaleX) * N) / N, Ir = Math.max(nt, Di).toString().length * z;
    let ji = Math.ceil(Ir / b) * b;
    for (let X = 0; X < x; X++) {
      let W = P + X * b;
      S.push(W, a, 0, W, r, 0), W = Math.round(W * N) / N, ji = Math.round(ji * N) / N;
      const we = W % ji;
      if (!(b < 1 || v < 1) && Math.abs(we) > 0.01)
        continue;
      const Bi = this.newNumber((W + this._offsetX) / this.scaleX), Mr = 12 * m;
    ...
    const Or = new BufferAttribute(new Float32Array(S), 3), Rr = new BufferAttribute(new Float32Array(zi), 3), { main: Pr, secondary: Nr } = this.grids;
  ...
  newGrid(t) {
    const e = new BufferGeometry(), o = new LineSegments(e, this.material);
    return o.frustumCulled = false, o.renderOrder = t, o;
  }
  isGridReady() {
...
var ii = (i, t, e, o) => {
  for (var n = Nu(t, e), s = i.length - 1, r; s >= 0; s--)
    (r = i[s]) && (n = r(t, e, n) || n);
  return n && Pu(t, e, n), n;
};
var zn = class zn2 extends Ht {
  constructor() {
  ...
  set components(t) {
    this.dispose();
    const o = t.get(Worlds).create();
    this._world = o, o.scene = new SimpleScene(t), o.scene.setup(), o.renderer = new Xd(t, this);
    const n = new OrthoPerspectiveCamera(t);
    o.camera = n;
    const s = new Ru(n.threeOrtho, this);
    this._grid = s, o.scene.three.add(s.get()), n.controls.addEventListener(
      "update",
      () => s.regenerate()
    ), setTimeout(async () => {
...
var Tt = zn;
ii([
  Z({ type: String, attribute: "grid-color", reflect: true })
], Tt.prototype, "gridColor");
ii([
  Z({ type: Number, attribute: "grid-scale-x", reflect: true })
], Tt.prototype, "gridScaleX");
ii([
  Z({ type: Number, attribute: "grid-scale-y", reflect: true })
], Tt.prototype, "gridScaleY");
ii([
  Z({ type: Number, attribute: "grid-offset-x", reflect: true })
], Tt.prototype, "gridOffsetX");
ii([
  Z({ type: Number, attribute: "grid-offset-y", reflect: true })
...
Nt([
  Z({ type: String, attribute: "right-text", reflect: true })
], dt.prototype, "rightText");
Nt([
  Z({ type: String, attribute: "left-text", reflect: true })
], dt.prototype, "leftText");
Nt([
  Z({ type: String, attribute: "top-text", reflect: true })
], dt.prototype, "topText");
Nt([
  Z({ type: String, attribute: "bottom-text", reflect: true })
], dt.prototype, "bottomText");
Nt([
  Z({ type: String, attribute: "front-text", reflect: true })
], dt.prototype, "frontText");
Nt([
  Z({ type: String, attribute: "back-text", reflect: true })
], dt.prototype, "backText");
Nt([
  Iu()
], dt.prototype, "_cssMatrix3D");
...
var Bn = class Bn2 extends Ht {
  ...
  set components(t) {
    ...
    if (this._components = t, this.components) {
      const o = this.components.get(Worlds);
  ...
  firstUpdated() {
    ...
    const { postproduction: n } = o, s = new OrthoPerspectiveCamera(this.components);
    this.world.camera = s;
    const r = this.components.get(Grids).create(this.world);
    r.material.uniforms.uColor.value = new Color(4342338), r.material.uniforms.uSize1.value = 2, r.material.uniforms.uSize2.value = 8, n.enabled = true, n.customEffects.excludedMeshes.push(r.three), n.setPasses({ custom: true, ao: true, gamma: true }), n.customEffects.lineColor = 1513756;
  }
  onSlotChange() {
